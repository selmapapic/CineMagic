        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HallImageUrl = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActorMovieLinks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActorMovieLinks_Actors_ActorId",
                        column: x => x.ActorId,
                        principalTable: "Actors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActorMovieLinks_Movies_MovieId",
                        column: x => x.MovieId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenreMovieLinks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GenreMovieLinks_MovieGenres_MovieGenreId",
                        column: x => x.MovieGenreId,
                        principalTable: "MovieGenres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GenreMovieLinks_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProjectionTime = table.Column<DateTime>(nullable: false),
                    MovieId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projections_CinemaHalls_CinemaHallId",
                        column: x => x.CinemaHallId,
                        principalTable: "CinemaHalls",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AvailableSeats_Projections_ProjectionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActorMovieLinks_MovieId",
                table: "ActorMovieLinks",
                column: "MovieId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailableSeats_ProjectionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GenreMovieLinks_MovieId",
                table: "GenreMovieLinks",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_Projections_CinemaHallId",
                table: "Projections",
                column: "CinemaHallId");
